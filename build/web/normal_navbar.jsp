<nav class="navbar navbar-expand-lg primary-background" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="loginPage.jsp"><span class="fa fa-user-circle-o fa-spin"></span>LogIn</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="Register.jsp"><span class="fa fa-sign-in"></span>SignUp</a>
            </li>
        </ul>
